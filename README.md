...
|รายการ        |รายละเอียด                                       |
|--------------|------------------------------------------------|
|**แหล่ง**      |OPAC ห้องสมุด YRU                                 |
|**URL**       |<https://opac.yru.ac.th/bibitem?bibid=b00048897>|
...
|รายการ        |รายละเอียด                    |
|--------------|-----------------------------|
|**บรรณาธิการ** |Ian P. Hall, Munir Pirmohamed|
|**สำนักพิมพ์**    |CRC Press / Taylor & Francis |
|**ปี**         |2006                         |
...
|รายการ        |รายละเอียด                                                                |
|--------------|-------------------------------------------------------------------------|
|**บรรณาธิการ** |Anke-Hilse Maitland-van der Zee (Utrecht U.) · Ann K. Daly (Newcastle U.)|
|**สำนักพิมพ์**    |John Wiley & Sons                                                        |
|**ปี**         |2012                                                                     |
|**ISBN**      |978-0-470-43354-6                                                        |
|**จำนวนหน้า**   |510 หน้า                                                                  |
...
|บท  |หัวข้อ                                                                        |
|----|----------------------------------------------------------------------------|
|Ch.1|Pharmacogenetics: A Historical Perspective — *Ann K. Daly*                  |
|Ch.2|Pharmacogenetics in Drug Metabolism: Role of Phase I Enzymes (CYP & non-CYP)|
|Ch.3|Pharmacogenetics of Phase II Drug Metabolizing Enzymes                      |
|Ch.4|Pharmacogenetics of Drug Transporters                                       |
|Ch.5|Pharmacogenetics of Drug Targets (Pharmacodynamics)                         |

**PART II · Therapeutic Areas**

|บท   |หัวข้อ                                                                      |
|-----|--------------------------------------------------------------------------|
|Ch.6 |Cardiovascular Pharmacogenetics                                           |
|Ch.7 |Pharmacogenetics in Psychiatry                                            |
|Ch.8 |Pharmacogenetics in Cancer                                                |
|Ch.9 |Pharmacogenetics of Asthma & COPD                                         |
|Ch.10|Pharmacogenetics of Adverse Drug Reactions — *Daly, Armstrong, Pirmohamed*|
|Ch.11|Pharmacogenomics of Inflammatory Bowel Diseases                           |
|Ch.12|Pharmacogenetics of Pain Medication                                       |

**PART III · Clinical Implementation**

|บท   |หัวข้อ                                                 |
|-----|-----------------------------------------------------|
|Ch.13|Ethical and Social Issues in Pharmacogenomics Testing|

**PART IV · Developments in Pharmacogenetic Research**

|บท   |หัวข้อ                                                            |
|-----|----------------------------------------------------------------|
|Ch.14|High-Throughput Genotyping Technologies                         |
|Ch.15|Developments in Analyses in Pharmacogenetic Datasets (GWAS, WGS)|

**PART V · Industry & Regulatory Affairs** ← *มีเฉพาะเล่มนี้*

|บท   |หัวข้อ                                                          |
|-----|--------------------------------------------------------------|
|Ch.16|Applications of PGx in Pharmaceutical Research and Development|
|Ch.17|Role of Pharmacogenetics in Registration Processes (FDA/EMA)  |
...
|ประเทศ     |สถานการณ์                                                                              |
|-----------|--------------------------------------------------------------------------------------|
|**มาเลเซีย**|มีงานวิจัย PGx (University of Malaya) แต่ยังไม่พบหนังสือ PGx สำหรับประชาชนในภาษามาเลย์           |
|**สิงคโปร์** |Genome Institute of Singapore (GIS) ผลิตงานวิจัย PGx ระดับโลก แต่ยังไม่มีหนังสือ PGx สำหรับประชาชน|
|**เวียดนาม**|มีงานวิจัยด้าน CYP genotyping แต่ไม่พบหนังสือ PGx สำหรับประชาชนในภาษาเวียดนาม                    |
...
|Star Alleles / Phenotype 5 ระดับ          |✅           |✅                    |✅               |✅                 |✅                    |
|Prodrug (Codeine, Clopidogrel, Tamoxifen)|✅           |✅                    |✅               |✅                 |✅                    |
|CPIC Guidelines (Level A–C)              |✅           |✅                    |✅               |✅                 |✅                    |
...
|อนาคต PGx / Combinatorial PGx            |✅           |✅                    |✅               |✅                 |✅                    |
|**ข้อมูลเฉพาะคนไทย/เอเชีย (HLA variants)**  |**บางส่วน**  |**❌**                |**❌**           |**❌**             |**❌**                |
|ยามะเร็ง (Chemo / TPMT / DPYD / UGT1A1)   |❌           |✅                    |✅               |✅                 |✅                    |
|ยา HIV / Antiretrovirals (HLA-B*57:01)   |❌           |✅                    |✅               |✅                 |❌                    |
|ยาลดน้ำตาล (Metformin, SU)                 |❌           |✅                    |✅               |✅                 |❌                    |
|ยาโรคทางเดินหายใจ / Asthma / COPD         |❌           |✅                    |✅               |✅                 |✅                    |
...
|Historical Perspective of PGx (บทแยก)    |❌           |❌                    |❌               |❌                 |✅                    |


> ✅ = ครอบคลุม · บางส่วน = กล่าวถึงแต่ไม่มีบทแยก · ❌ = ไม่มี
...
นี่คือจุดเด่นของหนังสือเล่มนี้ ความถี่ของ HLA-B*15:02 ในคนไทยสูงกว่าคนยุโรปมาก ข้อมูล Genomics Thailand WGS 949 คน และ Thai 51 pharmacogenes WGS ให้ข้อมูลที่ไม่มีในหนังสือฝรั่งแม้แต่เล่มเดียว ควรขยายบทที่ 12 ให้มีตารางเปรียบเทียบความถี่อัลลีลไทย vs. ยุโรป vs. เอเชียตะวันออก
